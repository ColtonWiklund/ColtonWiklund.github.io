var paladin_talents =
{
	...
	"seraphims_grace":
	{
		...
		"description":	"Divine Aegis heals for an additional $V1% for each ally it passes through.",
		"values":	[
			{
				"name":	"$V1",
				"modifier":	"None",
	...
	"righteous_echo":
	{
		...
		"description":	"Hammer of the Righteous releases a wave of Holy energy, dealing $V1% of its damage to all enemies within 5 yards of the target.",
		"values":	[
			{
				"name":	"$V1",
				"modifier":	"None",
	...
	{
		"name":	"Diminish",
		"icon":	"inv_sword_2h_artifactashbringerpurified_d_03.jpg",
		"spec":	4,
		"specTier":	4,
		"isUnlocked":	false,
		"currentRank":	0,
		...
		"description":	"Blocking an enemy's attack reduces their Attack Power by $V1 for 5 seconds. Stacks refresh independently.",
		"values":	[
			{
				"name":	"$V1",
				"modifier":	"Attack",
	...
	"holy_shield_block_chance":
	{
		...
		"icon":	"inv_shield_1h_hyrja_d_01.jpg",
		"spec":	4,
		"specTier":	4,
		"isUnlocked":	false,
		"currentRank":	0,
	...
	"luminescence":
	{
		...
		"description":	"Every 1,000 health you receive from healing spells and effects restores $V1 health to all allies within 10 yards.",
		"values":	[
			{
				"name":	"$V1",
				"modifier":	"None",
	...
	"divine_purpose":
	{
		...
		"description":	"When Sanctify ends, you radiate a wave of light that travels 40 yards, healing allies equal to $V1% of all healing you received during Sanctify.\n\nIf you die during Sanctify, this effect is increased to $V2% of all healing you received.",
		"values":	[
			{
				"name":	"$V1",
				"modifier":	"None",
